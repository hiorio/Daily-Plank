...
const styles = StyleSheet.create({
  ...
  plankEarL: { left: 9, transform: [{ rotate: '18deg' }] },
  plankEarR: { left: 27, transform: [{ rotate: '-6deg' }] },
  plankBrow: {
    position: 'absolute',
    top: 18,
    width: 9,
  ...
  restEarL: { left: 12, transform: [{ rotate: '18deg' }] },
  restEarR: { left: 55, transform: [{ rotate: '-18deg' }] },
  restEye: {
    position: 'absolute',
    top: 35,
    width: 7,
